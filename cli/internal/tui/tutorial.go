...
var chapters = []chapter{
	...
	},
	{
		...
		commands: []string{"model", "models", "thinking", "theme", "provider", "repo", "config", "notes"},
	},
	{
	...
	},
	{
		...
		commands: []string{"skills", "ext", "x", "templates"},
	},
	{
		...
		commands: []string{"serve", "publish", "onboard", "hook"},
	},
	{
