...
export const SHORTCUTS: Shortcut[] = [
  ...
  { keys: "Ctrl+2", label: "Research", group: "Navigation" },
  { keys: "Ctrl+3", label: "Wiki", group: "Navigation" },
  { keys: "Ctrl+4", label: "Graph", group: "Navigation" },
  { keys: "Ctrl+5", label: "Cards", group: "Navigation" },
  { keys: "Ctrl+6", label: "Editor", group: "Navigation" },
  { keys: "Ctrl+7", label: "Browser", group: "Navigation" },
  { keys: "Ctrl+8", label: "Activity", group: "Navigation" },
  { keys: "Ctrl+9", label: "Extensions", group: "Navigation" },
  { keys: "Ctrl+,", label: "Settings", group: "Navigation" },
  ...
  { keys: "Ctrl+`", label: "Toggle terminal", group: "Editor" },
