...
export const SHORTCUTS: Shortcut[] = [
  ...
  { keys: "Ctrl+5", label: "Graph", group: "Navigation" },
  { keys: "Ctrl+6", label: "Activity", group: "Navigation" },
  { keys: "Ctrl+7", label: "Cards", group: "Navigation" },
  { keys: "Ctrl+8", label: "Extensions", group: "Navigation" },
  { keys: "Ctrl+9", label: "Settings", group: "Navigation" },
