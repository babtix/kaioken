...
const FOOTER_GROUPS: FooterGroup[] = [
  {
    ...
    links: [
      ...
      { label: 'Architectural pillars', href: '/#pillars' },
      { label: 'Built by Babtich', href: '/#builder' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'License (L0-NC)', href: 'https://github.com/babtix/kaioken/blob/master/LICENSE', external: true },
      ...
      <div className="wrap">
        ...
        <div className="ftr-grid">
          <div className="ftr-brand">
            ...
            <p className="fb-tagline mono">TERMINAL AI CODING AGENT + KNOWLEDGE ENGINE</p>
            <p className="fb-say">
              Local terminal AI coding agent with auto-test+fix (verify), isolated sub-agents on git worktrees (delegate), and deep knowledge engine with cited answers.
            </p>
            <div className="fb-badges">
              <span className="label fb-badge">v2.0.0</span>
              <span className="label fb-badge">L0-NC 2.0.1</span>
              <span className="label fb-badge">Go → TypeScript</span>
            </div>
          </div>
        ...
        <div className="ftr-end">
          <div className="ftr-end-left mono">
            ...
            <span>License Zero Noncommercial</span>
          </div>
