  ...
  return (
    <div
      className={cn(
        ...
        "shadow-[0_4px_16px_-4px_rgba(0,0,0,0.06)] dark:shadow-[0_24px_60px_-24px_#000,inset_0_1px_0_rgba(255,255,255,0.05)]",
        className
      )}
      {...props}
    >
      <div className="flex items-center gap-2 border-b border-border bg-kai-panel/60 px-3 py-2">
