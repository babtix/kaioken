      ...
      <section className="relative isolate overflow-hidden pt-8 pb-10">
        <div className="mx-auto max-w-6xl px-4 pt-8 pb-10 sm:px-6 sm:pt-12 sm:pb-14">
          <div className="animate-rise text-center">
            ...
            {/* DESKTOP APP Logo */}
            <div className="mx-auto flex max-w-full items-center justify-center px-2 select-none">
              <img
                src="/desktop-app-logo.png"
                alt="DESKTOP APP"
                className="h-auto w-full max-w-[820px] object-contain drop-shadow-[0_0_40px_rgba(255,135,0,0.35)]"
                loading="eager"
              />
            </div>
