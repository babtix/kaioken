...
const CLI = [
  ...
  { cmd: "kaioken status", args: "[-check] [-json]", summary: "Per-module freshness. -check is the CI drift gate: exit 0 fresh, 1 stale." },
  ...
  { cmd: "kaioken verify", args: "", summary: "Run the repo's build/test commands and fix failures with an agent." },
