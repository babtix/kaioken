...
const SECTION = "scroll-mt-0 border-t border-border/70 pb-16 sm:pb-20"
...
export default function Desktop() {
  ...
  return (
    <>
      <PageBackground />
      {/* ── hero — full screen takeover on landing ──────────────────────── */}
      <section className="relative isolate flex min-h-[100dvh] flex-col justify-between overflow-hidden pt-14">
